...
public interface UserService {
	 ...
	 * 
	 * @return user if user with provided username exists, otherwise empty 
	 * 		   optional is returned
	 */
	Optional<User> findByUsername(String username);
	
	/**
	 * Creates <i>user</i> provided as argument and stores said user in
	 * database.
	 *  
	 * @param user new user
	 * 
	...
	/**
	 * Saves <i>user</i> provided as argument in database.
	 * 
	...
	/**
	 * Checks whether user with provided <i>username</i> already exists 
	 * in the database. 
	 * 
	...
	/**
	 * Checks whether user with provided <i>email</i> already exists in
	 * the database.
	 * 
